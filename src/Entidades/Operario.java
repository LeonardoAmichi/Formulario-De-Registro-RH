...
public class Operario extends Empregado{
    ...
    public Operario(String cargo, double valorProducao, int codigoSetor, double salarioBase, String telefone, String endereco, String nome, Date dataNascimento, String sexo){
